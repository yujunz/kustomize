...
func newLoaderAtConfirmedDir(
	...
	referrer *fileLoader, getter targetGetter) *fileLoader {
	return &fileLoader{
		loadRestrictor: lr,
		root:           root,
		referrer:       referrer,
...
func newLoaderAtGitClone(
	...
	referrer *fileLoader, cloner git.Cloner, getter targetGetter) (ifc.Loader, error) {
